...
def group_get(lskhuvuc):
    bin_1={"NhanRac":"box_cardboard_paper","KhoiLuong":0,"ID_khoangrac":None}
    kl_1,kl_2,kl_3,kl_4=0,0,0,0
    bin_2={"NhanRac":"glass_metal_plastic","KhoiLuong":0, "ID_khoangrac":None}
    bin_3={"NhanRac":"organic","KhoiLuong":0, "ID_khoangrac":None}
    bin_4={"NhanRac":"other","KhoiLuong":0 ,"ID_khoangrac":None}
    newngay=[]
    for d in lskhuvuc:
        if d["TenNhan"]=="box_cardboard_paper":
            bin_1['ID_khoangrac']=d['ID_khoangrac']
